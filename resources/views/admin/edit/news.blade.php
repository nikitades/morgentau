...
@section('fields')
    <div class="form-group">
        ...
        <div class="col-sm-12">{!! Form::text('title', $item->title, ['class' => 'form-control', 'required' => 'required']) !!}</div>
    </div>
    <div class="form-group">
        {!! Form::label('date', 'Дата', ['class' => 'control-label col-sm-12']) !!}
        <div class="col-sm-12">
            {!! Form::input('date', 'date', $item->date, ['class' => 'form-control', 'required' => 'required']) !!}
        </div>
    </div>
    <div class="form-group">
