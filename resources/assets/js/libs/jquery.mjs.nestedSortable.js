...
(function( factory ) {
	...
	$.widget("mjs.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
		...
		_mouseDrag: function(event) {
            ...
            newList.classList = o.listClasses;
		...
		_mouseStop: function(event) {
			...
			this._pid_current = this._getPid($(this.domPosition.parent).parent());
			this._sort_current = this.domPosition.prev ? $(this.domPosition.prev).next().index() : 0;
			$.ui.sortable.prototype._mouseStop.apply(this, arguments); //asybnchronous execution, @see _clear for the relocate event.
		},

		_getPid: function (item) {
			return $(item).data("entity-id") || $(item).attr('id')
		},
		...
		_clear: function() {
			...
			//relocate event
			if (typeof this._pid_current == 'undefined') console.error('Не указан entity-id у сортируемого элемента!');
			if (!(this._pid_current === this._getPid(this._uiHash().item.parent().parent()) &&
